...
<body>
    ...
    <header class="topo-simples">
        ...
        <a href="<?= BASE_URL ?>/controllers/FilmeController.php?action=index" class="link-voltar">← Voltar ao
            catálogo</a>
    </header>
    ...
    <main class="form-container">
        ...
        <form method="POST" action="<?= BASE_URL ?>/controllers/FilmeController.php">
            ...
            <label>Título
                <input type="text" name="titulo" required value="<?= htmlspecialchars($filme['titulo'] ?? '') ?>">
            </label>
            ...
            <label>Capa (URL da imagem)
                <input type="text" name="capa" value="<?= htmlspecialchars($filme['capa'] ?? '') ?>">
            </label>
            ...
            <label>Tipo
                <select name="tipo">
                    ...
                    <option value="serie" <?= (($filme['tipo'] ?? '') === 'serie') ? 'selected' : '' ?>>Série</option>
                </select>
            </label>
